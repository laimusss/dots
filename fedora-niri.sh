...
# ----------------------------------------------------------------------
# Шаг 2: Решение проблемы с геоблоком Cisco OpenH264 (для РФ)
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# Шаг 3: Проверка наличия пакета niri в официальных репозиториях Fedora
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# Шаг 5: Установка niri из официального репозитория
# ----------------------------------------------------------------------
...
check_url() {
    curl --output /dev/null --silent --head --fail --max-time 10 "$1"
}

if check_url "$COPR_FONTS_URL"; then
